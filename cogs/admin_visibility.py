...
ADMIN_COMMAND_PERMISSIONS = {
    ...
    "internet_duyet": discord.Permissions(manage_guild=True),
    "internet_duyet_all": discord.Permissions(manage_guild=True),
    "internet_pending": discord.Permissions(manage_guild=True),
    "internet_scan": discord.Permissions(manage_guild=True),
    "internet_status": discord.Permissions(manage_guild=True),
    "internet_tuchoi": discord.Permissions(manage_guild=True),
    "internet_xem": discord.Permissions(manage_guild=True),
